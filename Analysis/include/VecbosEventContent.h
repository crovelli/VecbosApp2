...
public :
   ...
   Int_t           nEle;
   Int_t           chargeEle[8];   //[nEle]
   Float_t         energyEle[8];   //[nEle]
   Float_t         thetaEle[8];   //[nEle]
   Float_t         etaEle[8];   //[nEle]
   Float_t         phiEle[8];   //[nEle]
   Float_t         pxEle[8];   //[nEle]
   Float_t         pyEle[8];   //[nEle]
   Float_t         pzEle[8];   //[nEle]
   Float_t         vertexXEle[8];   //[nEle]
   Float_t         vertexYEle[8];   //[nEle]
   Float_t         vertexZEle[8];   //[nEle]
   Int_t           fiducialFlagsEle[8];   //[nEle]
   Int_t           recoFlagsEle[8];   //[nEle]
   Float_t         trackMomentumErrorEle[8];   //[nEle]
   Int_t           superClusterIndexEle[8];   //[nEle]
   Int_t           PFsuperClusterIndexEle[8];   //[nEle]
   Int_t           trackIndexEle[8];   //[nEle]
   Int_t           gsfTrackIndexEle[8];   //[nEle]
   Float_t         convDistEle[8];   //[nEle]
   Float_t         convDcotEle[8];   //[nEle]
   Float_t         convRadiusEle[8];   //[nEle]
   Int_t           convTrackIndexEle[8];   //[nEle]
   Int_t           scPixChargeEle[8];   //[nEle]
   Bool_t          hasMatchedConversionEle[8];   //[nEle]
   Int_t           classificationEle[8];   //[nEle]
   Float_t         fbremEle[8];   //[nEle]
   Int_t           nbremsEle[8];   //[nEle]
   Float_t         hOverEEle[8];   //[nEle]
   Float_t         eSuperClusterOverPEle[8];   //[nEle]
   Float_t         eSeedOverPoutEle[8];   //[nEle]
   Float_t         eEleClusterOverPoutEle[8];   //[nEle]
   Float_t         deltaEtaAtVtxEle[8];   //[nEle]
   Float_t         deltaPhiAtVtxEle[8];   //[nEle]
   Float_t         deltaEtaAtCaloEle[8];   //[nEle]
   Float_t         deltaPhiAtCaloEle[8];   //[nEle]
   Float_t         deltaEtaEleClusterTrackAtCaloEle[8];   //[nEle]
   Float_t         deltaPhiEleClusterTrackAtCaloEle[8];   //[nEle]
   Float_t         dr03TkSumPtEle[8];   //[nEle]
   Float_t         dr03EcalRecHitSumEtEle[8];   //[nEle]
   Float_t         dr03HcalTowerSumEtEle[8];   //[nEle]
   Float_t         dr04TkSumPtEle[8];   //[nEle]
   Float_t         dr04EcalRecHitSumEtEle[8];   //[nEle]
   Float_t         dr04HcalTowerSumEtEle[8];   //[nEle]
   Float_t         dr03HcalTowerSumEtFullConeEle[8];   //[nEle]
   Float_t         dr04HcalTowerSumEtFullConeEle[8];   //[nEle]
   Float_t         pflowMVAEle[8];   //[nEle]
   Float_t         mvaidnontrigEle[8];   //[nEle]
   Float_t         mvaidtrigEle[8];   //[nEle]
   Float_t         mvaidisotrigEle[8];   //[nEle]
   Float_t         pfCombinedIsoEle[8];   //[nEle]
   Float_t         pfCandChargedIso03Ele[8];   //[nEle]
   Float_t         pfCandNeutralIso03Ele[8];   //[nEle]
   Float_t         pfCandPhotonIso03Ele[8];   //[nEle]
   Float_t         pfCandChargedIso04Ele[8];   //[nEle]
   Float_t         pfCandNeutralIso04Ele[8];   //[nEle]
   Float_t         pfCandPhotonIso04Ele[8];   //[nEle]
   Float_t         pfCandChargedDirIso04Ele[8];   //[nEle]
   Float_t         pfCandNeutralDirIso04Ele[8];   //[nEle]
   Float_t         pfCandPhotonDirIso04Ele[8];   //[nEle]
   Float_t         pfCandChargedPUIso03Ele[8];   //[nEle]
   Float_t         pfCandChargedPUIso04Ele[8];   //[nEle]
   Float_t         calibEnergyEle[8];   //[nEle]
   Float_t         calibEnergyErrorEle[8];   //[nEle]
   Int_t           nPho;
   Int_t           nPerPVPho;
   Int_t           chargePho[8];   //[nPho]
   Float_t         energyPho[8];   //[nPho]
   Float_t         thetaPho[8];   //[nPho]
   Float_t         etaPho[8];   //[nPho]
   Float_t         phiPho[8];   //[nPho]
   Float_t         pxPho[8];   //[nPho]
   Float_t         pyPho[8];   //[nPho]
   Float_t         pzPho[8];   //[nPho]
   Float_t         vertexXPho[8];   //[nPho]
   Float_t         vertexYPho[8];   //[nPho]
   Float_t         vertexZPho[8];   //[nPho]
   Int_t           fiducialFlagsPho[8];   //[nPho]
   Int_t           recoFlagsPho[8];   //[nPho]
   Int_t           superClusterIndexPho[8];   //[nPho]
   Int_t           PFsuperClusterIndexPho[8];   //[nPho]
   Float_t         hOverEPho[8];   //[nPho]
   Float_t         hTowOverEPho[8];   //[nPho]
   Float_t         dr03TkSumPtPho[8];   //[nPho]
   Float_t         dr03HollowTkSumPtPho[8];   //[nPho]
   Float_t         dr03EcalRecHitSumEtPho[8];   //[nPho]
   Float_t         dr03HcalTowerSumEtPho[8];   //[nPho]
   Float_t         dr04TkSumPtPho[8];   //[nPho]
   Float_t         dr04HollowTkSumPtPho[8];   //[nPho]
   Float_t         dr04EcalRecHitSumEtPho[8];   //[nPho]
   Float_t         dr04HcalTowerSumEtPho[8];   //[nPho]
   Float_t         chargedHadronIsoPho[8];   //[nPho]
   Float_t         neutralHadronIsoPho[8];   //[nPho]
   Float_t         photonIsoPho[8];   //[nPho]
   Int_t           hasPixelSeedPho[8];   //[nPho]
   Bool_t          hasMatchedConversionPho[8];   //[nPho]
   Float_t         dr02NeutralHadronPFIsoPho[8];   //[nPho]
   Float_t         dr02PhotonPFIsoPho[8];   //[nPho]
   Float_t         dr03NeutralHadronPFIsoPho[8];   //[nPho]
   Float_t         dr03PhotonPFIsoPho[8];   //[nPho]
   Float_t         dr04NeutralHadronPFIsoPho[8];   //[nPho]
   Float_t         dr04PhotonPFIsoPho[8];   //[nPho]
   ...
   Float_t         seedClusterEnergyPFSC[5];   //[nPFSC]
   Float_t         esEnergyPFSC[5];   //[nPFSC]
   Float_t         etaPFSC[5];   //[nPFSC]
   Float_t         thetaPFSC[5];   //[nPFSC]
   Float_t         phiPFSC[5];   //[nPFSC]
   Float_t         xPosPFSC[5];   //[nPFSC]
   Float_t         yPosPFSC[5];   //[nPFSC]
   Float_t         zPosPFSC[5];   //[nPFSC]
   Float_t         phiWidthPFSC[5];   //[nPFSC]
   Float_t         etaWidthPFSC[5];   //[nPFSC]
   Float_t         e3x3PFSC[5];   //[nPFSC]
   Float_t         e3x1PFSC[5];   //[nPFSC]
   Float_t         e1x3PFSC[5];   //[nPFSC]
   Float_t         e4x4PFSC[5];   //[nPFSC]
   ...
   Float_t         e2x5LeftPFSC[5];   //[nPFSC]
   Float_t         e2x5RightPFSC[5];   //[nPFSC]
   Float_t         e2x5TopPFSC[5];   //[nPFSC]
   Float_t         e2x5BottomPFSC[5];   //[nPFSC]
   Float_t         eLeftPFSC[5];   //[nPFSC]
   Float_t         eRightPFSC[5];   //[nPFSC]
   Float_t         eTopPFSC[5];   //[nPFSC]
   Float_t         eBottomPFSC[5];   //[nPFSC]
   ...
   Float_t         esEffsIxIxPFSC[5];   //[nPFSC]
   Float_t         esEffsIyIyPFSC[5];   //[nPFSC]
   Float_t         esL1EnergyPFSC[5];   //[nPFSC]
   Float_t         esL2EnergyPFSC[5];   //[nPFSC]
   Int_t           esL1StripsPFSC[5];   //[nPFSC]
   Int_t           esL2StripsPFSC[5];   //[nPFSC]
   Int_t           nTrack;
   Float_t         pxTrack[42];   //[nTrack]
   Float_t         pyTrack[42];   //[nTrack]
   Float_t         pzTrack[42];   //[nTrack]
   Int_t           vtxIndexTrack[42];   //[nTrack]
   Float_t         vtxWeightTrack[42];   //[nTrack]
   Float_t         impactPar3DTrack[42];   //[nTrack]
   Float_t         impactPar3DErrorTrack[42];   //[nTrack]
   Float_t         transvImpactParTrack[42];   //[nTrack]
   Float_t         transvImpactParErrorTrack[42];   //[nTrack]
   Float_t         impactPar3DBiasedTrack[42];   //[nTrack]
   Float_t         impactPar3DBiasedErrorTrack[42];   //[nTrack]
   Float_t         transvImpactParBiasedTrack[42];   //[nTrack]
   Float_t         transvImpactParBiasedErrorTrack[42];   //[nTrack]
   Float_t         chargeTrack[42];   //[nTrack]
   Float_t         ptErrorTrack[42];   //[nTrack]
   Float_t         trackValidHitsTrack[42];   //[nTrack]
   Float_t         trackLostHitsTrack[42];   //[nTrack]
   Float_t         trackNormalizedChi2Track[42];   //[nTrack]
   Int_t           qualityMaskTrack[42];   //[nTrack]
   Float_t         trackVxTrack[42];   //[nTrack]
   Float_t         trackVyTrack[42];   //[nTrack]
   Float_t         trackVzTrack[42];   //[nTrack]
   Float_t         d0Track[42];   //[nTrack]
   Float_t         d0ErrorTrack[42];   //[nTrack]
   Float_t         dzTrack[42];   //[nTrack]
   Float_t         dzErrorTrack[42];   //[nTrack]
   Int_t           pixelHitsTrack[42];   //[nTrack]
   Int_t           trackerLayersWithMeasurementTrack[42];   //[nTrack]
   Int_t           expInnerLayersTrack[42];   //[nTrack]
   Int_t           numberOfValidPixelBarrelHitsTrack[42];   //[nTrack]
   Int_t           numberOfValidPixelEndcapHitsTrack[42];   //[nTrack]
   Int_t           numberOfValidStripTIBHitsTrack[42];   //[nTrack]
   Int_t           numberOfValidStripTIDHitsTrack[42];   //[nTrack]
   Int_t           numberOfValidStripTOBHitsTrack[42];   //[nTrack]
   Int_t           numberOfValidStripTECHitsTrack[42];   //[nTrack]
   Int_t           numberOfValidMuonHitsTrack[42];   //[nTrack]
   Int_t           nGsfTrack;
   Float_t         pxGsfTrack[32];   //[nGsfTrack]
   Float_t         pyGsfTrack[32];   //[nGsfTrack]
   Float_t         pzGsfTrack[32];   //[nGsfTrack]
   Int_t           vtxIndexGsfTrack[32];   //[nGsfTrack]
   Float_t         vtxWeightGsfTrack[32];   //[nGsfTrack]
   Float_t         impactPar3DGsfTrack[32];   //[nGsfTrack]
   Float_t         impactPar3DErrorGsfTrack[32];   //[nGsfTrack]
   Float_t         transvImpactParGsfTrack[32];   //[nGsfTrack]
   Float_t         transvImpactParErrorGsfTrack[32];   //[nGsfTrack]
   Float_t         impactPar3DBiasedGsfTrack[32];   //[nGsfTrack]
   Float_t         impactPar3DBiasedErrorGsfTrack[32];   //[nGsfTrack]
   Float_t         transvImpactParBiasedGsfTrack[32];   //[nGsfTrack]
   Float_t         transvImpactParBiasedErrorGsfTrack[32];   //[nGsfTrack]
   Float_t         chargeGsfTrack[32];   //[nGsfTrack]
   Float_t         ptErrorGsfTrack[32];   //[nGsfTrack]
   Float_t         trackValidHitsGsfTrack[32];   //[nGsfTrack]
   Float_t         trackLostHitsGsfTrack[32];   //[nGsfTrack]
   Float_t         trackNormalizedChi2GsfTrack[32];   //[nGsfTrack]
   Int_t           qualityMaskGsfTrack[32];   //[nGsfTrack]
   Float_t         trackVxGsfTrack[32];   //[nGsfTrack]
   Float_t         trackVyGsfTrack[32];   //[nGsfTrack]
   Float_t         trackVzGsfTrack[32];   //[nGsfTrack]
   Float_t         d0GsfTrack[32];   //[nGsfTrack]
   Float_t         d0ErrorGsfTrack[32];   //[nGsfTrack]
   Float_t         dzGsfTrack[32];   //[nGsfTrack]
   Float_t         dzErrorGsfTrack[32];   //[nGsfTrack]
   Int_t           pixelHitsGsfTrack[32];   //[nGsfTrack]
   Int_t           trackerLayersWithMeasurementGsfTrack[32];   //[nGsfTrack]
   Int_t           expInnerLayersGsfTrack[32];   //[nGsfTrack]
   Int_t           numberOfValidPixelBarrelHitsGsfTrack[32];   //[nGsfTrack]
   Int_t           numberOfValidPixelEndcapHitsGsfTrack[32];   //[nGsfTrack]
   Int_t           numberOfValidStripTIBHitsGsfTrack[32];   //[nGsfTrack]
   Int_t           numberOfValidStripTIDHitsGsfTrack[32];   //[nGsfTrack]
   Int_t           numberOfValidStripTOBHitsGsfTrack[32];   //[nGsfTrack]
   Int_t           numberOfValidStripTECHitsGsfTrack[32];   //[nGsfTrack]
   Int_t           numberOfValidMuonHitsGsfTrack[32];   //[nGsfTrack]
   Int_t           chargeModeGsfTrack[32];   //[nGsfTrack]
   Float_t         pxModeGsfTrack[32];   //[nGsfTrack]
   Float_t         pyModeGsfTrack[32];   //[nGsfTrack]
   Float_t         pzModeGsfTrack[32];   //[nGsfTrack]
   ...
   Float_t         d0GlobalMuonTrack[5];   //[nGlobalMuonTrack]
   Float_t         d0ErrorGlobalMuonTrack[5];   //[nGlobalMuonTrack]
   Float_t         dzGlobalMuonTrack[5];   //[nGlobalMuonTrack]
   Float_t         dzErrorGlobalMuonTrack[5];   //[nGlobalMuonTrack]
   Int_t           pixelHitsGlobalMuonTrack[5];   //[nGlobalMuonTrack]
   Int_t           trackerLayersWithMeasurementGlobalMuonTrack[5];   //[nGlobalMuonTrack]
   ...
   Int_t           numberOfValidMuonHitsGlobalMuonTrack[5];   //[nGlobalMuonTrack]
   Int_t           nSTAMuonTrack;
   ...
   Float_t         d0STAMuonTrack[6];   //[nSTAMuonTrack]
   Float_t         d0ErrorSTAMuonTrack[6];   //[nSTAMuonTrack]
   Float_t         dzSTAMuonTrack[6];   //[nSTAMuonTrack]
   Float_t         dzErrorSTAMuonTrack[6];   //[nSTAMuonTrack]
   Int_t           pixelHitsSTAMuonTrack[6];   //[nSTAMuonTrack]
   Int_t           trackerLayersWithMeasurementSTAMuonTrack[6];   //[nSTAMuonTrack]
   ...
   Int_t           numberOfValidMuonHitsSTAMuonTrack[6];   //[nSTAMuonTrack]
   Int_t           nPV;
   Float_t         PVxPV[51];   //[nPV]
   Float_t         PVyPV[51];   //[nPV]
   Float_t         PVzPV[51];   //[nPV]
   Float_t         PVErrxPV[51];   //[nPV]
   Float_t         PVErryPV[51];   //[nPV]
   Float_t         PVErrzPV[51];   //[nPV]
   Float_t         SumPtPV[51];   //[nPV]
   Float_t         rhoPV[51];   //[nPV]
   Float_t         ndofPV[51];   //[nPV]
   Float_t         chi2PV[51];   //[nPV]
   Float_t         normChi2PV[51];   //[nPV]
   Float_t         pxChMetPV[51];   //[nPV]
   Float_t         pyChMetPV[51];   //[nPV]
   Float_t         pzChMetPV[51];   //[nPV]
   Int_t           isFakePV[51];   //[nPV]
   Int_t           isValidPV[51];   //[nPV]
   Int_t           trackSizePV[51];   //[nPV]
   Int_t           nMuon;
   Int_t           chargeMuon[40];   //[nMuon]
   Float_t         energyMuon[40];   //[nMuon]
   Float_t         thetaMuon[40];   //[nMuon]
   Float_t         etaMuon[40];   //[nMuon]
   Float_t         phiMuon[40];   //[nMuon]
   Float_t         pxMuon[40];   //[nMuon]
   Float_t         pyMuon[40];   //[nMuon]
   Float_t         pzMuon[40];   //[nMuon]
   Float_t         vertexXMuon[40];   //[nMuon]
   Float_t         vertexYMuon[40];   //[nMuon]
   Float_t         vertexZMuon[40];   //[nMuon]
   Int_t           trackIndexMuon[40];   //[nMuon]
   Int_t           standAloneTrackIndexMuon[40];   //[nMuon]
   Int_t           combinedTrackIndexMuon[40];   //[nMuon]
   Int_t           muonIdMuon[40];   //[nMuon]
   Bool_t          pfmuonIdMuon[40];   //[nMuon]
   Int_t           typeMuon[40];   //[nMuon]
   Int_t           numberOfMatchesMuon[40];   //[nMuon]
   Float_t         sumPt03Muon[40];   //[nMuon]
   Float_t         emEt03Muon[40];   //[nMuon]
   Float_t         hadEt03Muon[40];   //[nMuon]
   Float_t         hoEt03Muon[40];   //[nMuon]
   Float_t         nTrk03Muon[40];   //[nMuon]
   Float_t         nJets03Muon[40];   //[nMuon]
   Float_t         sumPt05Muon[40];   //[nMuon]
   Float_t         emEt05Muon[40];   //[nMuon]
   Float_t         hadEt05Muon[40];   //[nMuon]
   Float_t         hoEt05Muon[40];   //[nMuon]
   Float_t         nTrk05Muon[40];   //[nMuon]
   Float_t         nJets05Muon[40];   //[nMuon]
   Float_t         pfCombinedIsoMuon[40];   //[nMuon]
   Float_t         pfCandChargedIso03Muon[40];   //[nMuon]
   Float_t         pfCandNeutralIso03Muon[40];   //[nMuon]
   Float_t         pfCandPhotonIso03Muon[40];   //[nMuon]
   Float_t         pfCandChargedIso04Muon[40];   //[nMuon]
   Float_t         pfCandNeutralIso04Muon[40];   //[nMuon]
   Float_t         pfCandPhotonIso04Muon[40];   //[nMuon]
   Float_t         pfCandChargedDirIso04Muon[40];   //[nMuon]
   Float_t         pfCandNeutralDirIso04Muon[40];   //[nMuon]
   Float_t         pfCandPhotonDirIso04Muon[40];   //[nMuon]
   Float_t         pfIsolationSumPUPtR03Muon[40];   //[nMuon]
   Float_t         pfIsolationSumPUPtR04Muon[40];   //[nMuon]
   Float_t         pfCandChargedPUIso03Muon[40];   //[nMuon]
   Float_t         pfCandChargedPUIso04Muon[40];   //[nMuon]
   Float_t         kinkMuon[40];   //[nMuon]
   Float_t         mvaisoMuon[40];   //[nMuon]
   Float_t         scaledMomentumMuon[40];   //[nMuon]
   Int_t           nPFCand;
   Int_t           chargePFCand[17];   //[nPFCand]
   Float_t         energyPFCand[17];   //[nPFCand]
   Float_t         thetaPFCand[17];   //[nPFCand]
   Float_t         etaPFCand[17];   //[nPFCand]
   Float_t         phiPFCand[17];   //[nPFCand]
   Float_t         pxPFCand[17];   //[nPFCand]
   Float_t         pyPFCand[17];   //[nPFCand]
   Float_t         pzPFCand[17];   //[nPFCand]
   Float_t         vertexXPFCand[17];   //[nPFCand]
   Float_t         vertexYPFCand[17];   //[nPFCand]
   Float_t         vertexZPFCand[17];   //[nPFCand]
   Int_t           particleIdPFCand[17];   //[nPFCand]
   Double_t        ChargedIso03PFCand[17];   //[nPFCand]
   Double_t        NeutralIso03PFCand[17];   //[nPFCand]
   Double_t        PhotonIso03PFCand[17];   //[nPFCand]
   Double_t        SumPUPtR03PFCand[17];   //[nPFCand]
   Int_t           nReducedPFCand;
   Int_t           chargeReducedPFCand[812];   //[nReducedPFCand]
   Float_t         energyReducedPFCand[812];   //[nReducedPFCand]
   Float_t         thetaReducedPFCand[812];   //[nReducedPFCand]
   Float_t         etaReducedPFCand[812];   //[nReducedPFCand]
   Float_t         phiReducedPFCand[812];   //[nReducedPFCand]
   Float_t         pxReducedPFCand[812];   //[nReducedPFCand]
   Float_t         pyReducedPFCand[812];   //[nReducedPFCand]
   Float_t         pzReducedPFCand[812];   //[nReducedPFCand]
   Float_t         vertexXReducedPFCand[812];   //[nReducedPFCand]
   Float_t         vertexYReducedPFCand[812];   //[nReducedPFCand]
   Float_t         vertexZReducedPFCand[812];   //[nReducedPFCand]
   Int_t           nMet;
   ...
   Int_t           chargeAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         energyAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         uncorrenergyAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         thetaAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         etaAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         phiAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         pxAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         pyAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         pzAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         uncorrpxAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         uncorrpyAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         uncorrpzAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         vertexXAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         vertexYAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         vertexZAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         chargedHadronEnergyAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         neutralHadronEnergyAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         photonEnergyAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         electronEnergyAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         muonEnergyAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         HFHadronEnergyAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         HFEMEnergyAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Int_t           chargedHadronMultiplicityAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Int_t           neutralHadronMultiplicityAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Int_t           photonMultiplicityAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Int_t           electronMultiplicityAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Int_t           muonMultiplicityAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Int_t           HFHadronMultiplicityAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Int_t           HFEMMultiplicityAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         areaAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         weightedDz1AK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         weightedDz2AK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         betastarAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         rmsCandsHandAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         jetIdMvaFullAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         dR2MeanIdMvaAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         dRMeanIdMvaAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         betastarIdMvaAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         betastarclassicIdMvaAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         chargedEmEnergyAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         neutralEmEnergyAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         combinedSecondaryVertexBJetTagsAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         combinedSecondaryVertexMVABJetTagsAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         jetBProbabilityBJetTagsAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         jetProbabilityBJetTagsAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         simpleSecondaryVertexHighEffBJetTagsAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         simpleSecondaryVertexHighPurBJetTagsAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         trackCountingHighPurBJetTagsAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         trackCountingHighEffBJetTagsAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         trackCountingVeryHighEffBJetTagsAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         rmsCandAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         ptDAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         axis1AK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         axis2AK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         pullAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         tanaAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         rmsCand_QCAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         ptD_QCAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         axis1_QCAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         axis2_QCAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         pull_QCAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         tana_QCAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Int_t           nChg_ptCutAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Int_t           nChg_QCAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Int_t           nChg_ptCut_QCAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Int_t           nNeutral_ptCutAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         RchgAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         RneutralAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         RAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         Rchg_QCAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         pTMaxAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         pTMaxChgAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         pTMaxNeutralAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Float_t         pTMaxChg_QCAK5PFPUcorrJet[93];   //[nAK5PFPUcorrJet]
   Int_t           nAK5GenJet;
   Int_t           chargeAK5GenJet[13];   //[nAK5GenJet]
   Float_t         energyAK5GenJet[13];   //[nAK5GenJet]
   Float_t         thetaAK5GenJet[13];   //[nAK5GenJet]
   Float_t         etaAK5GenJet[13];   //[nAK5GenJet]
   Float_t         phiAK5GenJet[13];   //[nAK5GenJet]
   Float_t         pxAK5GenJet[13];   //[nAK5GenJet]
   Float_t         pyAK5GenJet[13];   //[nAK5GenJet]
   Float_t         pzAK5GenJet[13];   //[nAK5GenJet]
   Float_t         vertexXAK5GenJet[13];   //[nAK5GenJet]
   Float_t         vertexYAK5GenJet[13];   //[nAK5GenJet]
   Float_t         vertexZAK5GenJet[13];   //[nAK5GenJet]
   Double_t        genPtHat;
